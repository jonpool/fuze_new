...
import Navigation from 'src/theme-layouts/shared-components/navigation/Navigation';
...
import NavbarPinToggleButton from 'src/theme-layouts/shared-components/navbar/NavbarPinToggleButton';
