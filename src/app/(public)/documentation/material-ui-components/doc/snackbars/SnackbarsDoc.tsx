...
function SnackbarsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Snackbar</Typography>
...
<Typography className="text-base mb-32" component="div">The Snackbar component appears temporarily and floats above the UI to provide users with (non-critical) updates on an app&#39;s processes.
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Position</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`anchorOrigin`}</code> prop to control the Snackbar&#39;s position on the screen.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Content</Typography>
...
<Typography className="text-base mb-32" component="div">Use the Snackbar Content component to add text and actions to the Snackbar.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Automatic dismiss</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`autoHideDuration`}</code> prop to automatically trigger the Snackbar&#39;s <code>{`onClose`}</code> function after a set period of time (in milliseconds).</Typography>
<Typography className="text-base mb-32" component="div">Make sure to <a href="https://www.w3.org/TR/UNDERSTANDING-WCAG20/time-limits.html">provide sufficient time</a> for the user to process the information displayed on it.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">You can use the <code>{`TransitionComponent`}</code> prop to change the transition of the Snackbar from <a href="/material-ui/transitions/#grow">Grow</a> (the default) to others such as <a href="/material-ui/transitions/#slide">Slide</a>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Use with Alerts</Typography>
<Typography className="text-base mb-32" component="div">Use an Alert inside a Snackbar for messages that communicate a certain severity.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Use with Floating Action Buttons</Typography>
<Typography className="text-base mb-32" component="div">If you&#39;re using a <a href="/material-ui/react-floating-action-button/">Floating Action Button</a> on mobile, Material Design recommends positioning snackbars directly above it, as shown in the demo below:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Common examples</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Consecutive Snackbars</Typography>
<Typography className="text-base mb-32" component="div">This demo shows how to display multiple Snackbars without stacking them by using a consecutive animation.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">With an imperative API, <a href="https://github.com/iamhosseindhv/notistack">notistack</a> lets you vertically stack multiple Snackbars without having to handle their open and close states.
...
<Typography className="text-base mb-32" component="div">The Snackbar component is composed of a root <code>{`<div>`}</code> that houses interior elements like the Snackbar Content and other optional components (such as buttons or decorators).</Typography>
