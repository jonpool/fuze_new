...
function AccordionDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Accordion</Typography>
...
<Typography className="text-base mb-32" component="div">The Material UI Accordion component includes several complementary utility components to handle various use cases:</Typography>
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Expand icon</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`expandIcon`}</code> prop on the Accordion Summary component to change the expand indicator icon.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Expanded by default</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`defaultExpanded`}</code> prop on the Accordion component to have it opened by default.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Transition</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`slots.transition`}</code> and <code>{`slotProps.transition`}</code> props to change the Accordion&#39;s default transition.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Disabled item</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`disabled`}</code> prop on the Accordion component to disable interaction and focus.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Controlled Accordion</Typography>
<Typography className="text-base mb-32" component="div">The Accordion component can be controlled or uncontrolled.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Only one expanded at a time</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`expanded`}</code> prop with React&#39;s <code>{`useState`}</code> hook to allow only one Accordion item to be expanded at a time.
The demo below also shows a bit of visual customization.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Changing heading level</Typography>
<Typography className="text-base mb-32" component="div">By default, the Accordion uses an <code>{`h3`}</code> element for the heading. You can change the heading element using the <code>{`slotProps.heading.component`}</code> prop to ensure the correct heading hierarchy in your document.</Typography>
...
<Typography className="text-base mb-32" component="div">The <a href="https://www.w3.org/WAI/ARIA/apg/patterns/accordion/">WAI-ARIA guidelines for accordions</a> recommend setting an <code>{`id`}</code> and <code>{`aria-controls`}</code>, which in this case would apply to the Accordion Summary component.
...
<Typography className="text-base mb-32" component="div">The Accordion component is composed of a root <code>{`<div>`}</code> that houses interior elements like the Accordion Summary and other optional components (such as buttons or decorators).</Typography>
