...
function TooltipsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Tooltip</Typography>
...
<Typography className="text-base mb-32" component="div">When activated, Tooltips display a text label identifying an element, such as a description of its function.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic tooltip</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicTooltipRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Positioned tooltips</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`Tooltip`}</code> has 12 <strong>placement</strong> choices.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Arrow tooltips</Typography>
<Typography className="text-base mb-32" component="div">You can use the <code>{`arrow`}</code> prop to give your tooltip an arrow indicating which element it refers to.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Distance from anchor</Typography>
<Typography className="text-base mb-32" component="div">To adjust the distance between the tooltip and its anchor, you can use the <code>{`slotProps`}</code> prop to modify the <a href="https://popper.js.org/docs/v2/modifiers/offset/">offset</a> of the popper.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">Alternatively, you can use the <code>{`slotProps`}</code> prop to customize the margin of the popper.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Custom child element</Typography>
<Typography className="text-base mb-32" component="div">The tooltip needs to apply DOM event listeners to its child element.
...
<Typography className="text-base mb-32" component="div">If using a class component as a child, you&#39;ll also need to ensure that the ref is forwarded to the underlying DOM element. (A ref to the class component itself will not work.)</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Triggers</Typography>
<Typography className="text-base mb-32" component="div">You can define the types of events that cause a tooltip to show.</Typography>
<Typography className="text-base mb-32" component="div">The touch action requires a long press due to the <code>{`enterTouchDelay`}</code> prop being set to <code>{`700`}</code>ms by default.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Controlled tooltips</Typography>
<Typography className="text-base mb-32" component="div">You can use the <code>{`open`}</code>, <code>{`onOpen`}</code> and <code>{`onClose`}</code> props to control the behavior of the tooltip.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Variable width</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`Tooltip`}</code> wraps long text by default to make it readable.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">Tooltips are interactive by default (to pass <a href="https://www.w3.org/TR/WCAG21/#content-on-hover-or-focus">WCAG 2.1 success criterion 1.4.13</a>).
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Disabled elements</Typography>
<Typography className="text-base mb-32" component="div">By default disabled elements like <code>{`<button>`}</code> do not trigger user interactions so a <code>{`Tooltip`}</code> will not activate on normal events like hover. To accommodate disabled elements, add a simple wrapper element, such as a <code>{`span`}</code>.</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Transitions</Typography>
<Typography className="text-base mb-32" component="div">Use a different transition.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Follow cursor</Typography>
<Typography className="text-base mb-32" component="div">You can enable the tooltip to follow the cursor by setting <code>{`followCursor={true}`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Virtual element</Typography>
<Typography className="text-base mb-32" component="div">In the event you need to implement a custom placement, you can use the <code>{`anchorEl`}</code> prop:
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Showing and hiding</Typography>
<Typography className="text-base mb-32" component="div">The tooltip is normally shown immediately when the user&#39;s mouse hovers over the element, and hides immediately when the user&#39;s mouse leaves. A delay in showing or hiding the tooltip can be added through the <code>{`enterDelay`}</code> and <code>{`leaveDelay`}</code> props.</Typography>
<Typography className="text-base mb-32" component="div">On mobile, the tooltip is displayed when the user longpresses the element and hides after a delay of 1500ms. You can disable this feature with the <code>{`disableTouchListener`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/tooltip/">https://www.w3.org/WAI/ARIA/apg/patterns/tooltip/</a>)</Typography>
<Typography className="text-base mb-32" component="div">By default, the tooltip only labels its child element.
...
<Typography className="text-base mb-32" component="div">the <code>{`title`}</code> acts as an accessible description.
