...
function SliderDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Slider</Typography>
<Typography className="description">Sliders allow users to make selections from a range of values.</Typography>

<Typography className="text-base mb-32" component="div">Sliders reflect a range of values along a bar, from which users may select a single value. They are ideal for adjusting settings such as volume, brightness, or applying image filters.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Continuous sliders</Typography>
<Typography className="text-base mb-32" component="div">Continuous sliders allow users to select a value along a subjective range.</Typography>
...
<Typography className="text-base mb-32" component="div">For smaller slider, use the prop <code>{`size="small"`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="SliderSizes.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={SliderSizesRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Discrete sliders</Typography>
<Typography className="text-base mb-32" component="div">Discrete sliders can be adjusted to a specific value by referencing its value indicator.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Small steps</Typography>
<Typography className="text-base mb-32" component="div">You can change the default step increment.
Make sure to adjust the <code>{`shiftStep`}</code> prop (the granularity with which the slider can step when using Page Up/Down or Shift + Arrow Up/Down) to a value divadable with the <code>{`step`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Custom marks</Typography>
<Typography className="text-base mb-32" component="div">You can have custom marks by providing a rich array to the <code>{`marks`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Restricted values</Typography>
<Typography className="text-base mb-32" component="div">You can restrict the selectable values to those provided with the <code>{`marks`}</code> prop with <code>{`step={null}`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Label always visible</Typography>
<Typography className="text-base mb-32" component="div">You can force the thumb label to be always visible with <code>{`valueLabelDisplay="on"`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Range slider</Typography>
<Typography className="text-base mb-32" component="div">The slider can be used to set the start and end of a range by supplying an array of values to the <code>{`value`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="RangeSlider.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={RangeSliderRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Minimum distance</Typography>
<Typography className="text-base mb-32" component="div">You can enforce a minimum distance between values in the <code>{`onChange`}</code> event handler.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Slider with input field</Typography>
<Typography className="text-base mb-32" component="div">In this example, an input allows a discrete value to be set.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="InputSlider.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Music player</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Vertical sliders</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div"><strong>WARNING</strong>: Chrome, Safari and newer Edge versions that is any browser based on WebKit exposes <code>{`<Slider orientation="vertical" />`}</code> as horizontal (<a href="https://bugs.chromium.org/p/chromium/issues/detail?id=1158217">chromium issue #1158217</a>).
By applying <code>{`-webkit-appearance: slider-vertical;`}</code> the slider is exposed as vertical.</Typography>
<Typography className="text-base mb-32" component="div">However, by applying <code>{`-webkit-appearance: slider-vertical;`}</code> keyboard navigation for horizontal keys (<kbd className="key">Arrow Left</kbd>, <kbd className="key">Arrow Right</kbd>) is reversed (<a href="https://bugs.chromium.org/p/chromium/issues/detail?id=1162640">chromium issue #1162640</a>).
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Marks placement</Typography>
<Typography className="text-base mb-32" component="div">You can customize your slider by adding and repositioning marks for minimum and maximum values.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="CustomMarks.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={CustomMarksRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Track</Typography>
<Typography className="text-base mb-32" component="div">The track shows the range available for user selection.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Removed track</Typography>
<Typography className="text-base mb-32" component="div">The track can be turned off with <code>{`track={false}`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Inverted track</Typography>
<Typography className="text-base mb-32" component="div">The track can be inverted with <code>{`track="inverted"`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Non-linear scale</Typography>
<Typography className="text-base mb-32" component="div">You can use the <code>{`scale`}</code> prop to represent the <code>{`value`}</code> on a different scale.</Typography>
<Typography className="text-base mb-32" component="div">In the following demo, the value <em>x</em> represents the value <em>2^x</em>.
...
<Typography className="text-base mb-32" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/slider-multithumb/">https://www.w3.org/WAI/ARIA/apg/patterns/slider-multithumb/</a>)</Typography>
<Typography className="text-base mb-32" component="div">The component handles most of the work necessary to make it accessible.
