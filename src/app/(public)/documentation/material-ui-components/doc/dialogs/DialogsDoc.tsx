...
function DialogsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Dialog</Typography>
...
<Typography className="text-base mb-32" component="div">A Dialog is a type of <a href="/material-ui/react-modal/">modal</a> window that appears in front of app content to provide critical information or ask for a decision. Dialogs disable all app functionality when they appear, and remain on screen until confirmed, dismissed, or a required action has been taken.</Typography>
<Typography className="text-base mb-32" component="div">Dialogs are purposefully interruptive, so they should be used sparingly.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Introduction</Typography>
<Typography className="text-base mb-32" component="div">Dialogs are implemented using a collection of related components:</Typography>
...
<li>Dialog Content Text: a wrapper for text inside of <code>{`<DialogContent />`}</code>.</li>
<li>Slide: optional <a href="/material-ui/transitions/#slide">Transition</a> used to slide the Dialog in from the edge of the screen.</li>
</ul>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Alerts</Typography>
<Typography className="text-base mb-32" component="div">Alerts are urgent interruptions, requiring acknowledgement, that inform the user about a situation.</Typography>
<Typography className="text-base mb-32" component="div">Most alerts don&#39;t need titles.
...
<Typography className="text-base mb-32" component="div">Use title bar alerts only for high-risk situations, such as the potential loss of connectivity.
Users should be able to understand the choices based on the title and button text alone.</Typography>
<Typography className="text-base mb-32" component="div">If a title is required:</Typography>
<ul className="space-y-16">
...
<Typography className="text-base mb-32" component="div">You can also swap out the transition, the next example uses <code>{`Slide`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Form dialogs</Typography>
<Typography className="text-base mb-32" component="div">Form dialogs allow users to fill out form fields within a dialog.
...
<Typography className="text-base mb-32" component="div">The dialog has a close button added to aid usability.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Full-screen dialogs</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Optional sizes</Typography>
<Typography className="text-base mb-32" component="div">You can set a dialog maximum width by using the <code>{`maxWidth`}</code> enumerable in combination with the <code>{`fullWidth`}</code> boolean.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Responsive full-screen</Typography>
<Typography className="text-base mb-32" component="div">You may make a dialog responsively full screen using <a href="/material-ui/react-use-media-query/"><code>{`useMediaQuery`}</code></a>.</Typography>
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Confirmation dialogs</Typography>
<Typography className="text-base mb-32" component="div">Confirmation dialogs require users to explicitly confirm their choice before an option is committed.
For example, users can listen to multiple ringtones but only make a final selection upon touching &quot;OK&quot;.</Typography>
<Typography className="text-base mb-32" component="div">Touching &quot;Cancel&quot; in a confirmation dialog, cancels the action, discards any changes, and closes the dialog.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Non-modal dialog</Typography>
<Typography className="text-base mb-32" component="div">Dialogs can also be non-modal, meaning they don&#39;t interrupt user interaction behind it.
...
<Typography className="text-base mb-32" component="div">The demo below shows a persistent cookie banner, a common non-modal dialog use case.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Draggable dialog</Typography>
<Typography className="text-base mb-32" component="div">You can create a draggable dialog by using <a href="https://github.com/react-grid-layout/react-draggable">react-draggable</a>.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Scrolling long content</Typography>
<Typography className="text-base mb-32" component="div">When dialogs become too long for the user&#39;s viewport or device, they scroll.</Typography>
<ul className="space-y-16">
...
<Typography className="text-base mb-32" component="div">Try the demo below to see what we mean:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
