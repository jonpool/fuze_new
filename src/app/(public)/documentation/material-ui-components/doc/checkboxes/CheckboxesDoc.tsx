...
function CheckboxesDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Checkbox</Typography>
<Typography className="description">Checkboxes allow the user to select one or more items from a set.</Typography>

<Typography className="text-base mb-32" component="div">Checkboxes can be used to turn an option on or off.</Typography>
<Typography className="text-base mb-32" component="div">If you have multiple options appearing in a list,
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic checkboxes</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={CheckboxesRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Label</Typography>
<Typography className="text-base mb-32" component="div">You can provide a label to the <code>{`Checkbox`}</code> thanks to the <code>{`FormControlLabel`}</code> component.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">Use the <code>{`size`}</code> prop or customize the font size of the svg icons to change the size of the checkboxes.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Icon</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Controlled</Typography>
<Typography className="text-base mb-32" component="div">You can control the checkbox with the <code>{`checked`}</code> and <code>{`onChange`}</code> props:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Indeterminate</Typography>
...
:::</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">FormGroup</Typography>
<Typography className="text-base mb-32" component="div"><code>{`FormGroup`}</code> is a helpful wrapper used to group selection control components.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">You can change the placement of the label:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">🎨 If you are looking for inspiration, you can check <a href="https://mui-treasury.com/?path=/docs/checkbox-introduction--docs">MUI Treasury&#39;s customization examples</a>.</Typography>
...
<Typography className="text-base mb-32" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/checkbox/">https://www.w3.org/WAI/ARIA/apg/patterns/checkbox/</a>)</Typography>
<ul className="space-y-16">
...
In this case, you can apply the additional attribute (for example <code>{`aria-label`}</code>, <code>{`aria-labelledby`}</code>, <code>{`title`}</code>) via the <code>{`inputProps`}</code> prop.</li>
</ul>
