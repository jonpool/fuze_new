...
function MenusDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Menu</Typography>
<Typography className="description">Menus display a list of choices on temporary surfaces.</Typography>

<Typography className="text-base mb-32" component="div">A menu displays a list of choices on a temporary surface. It appears when the user interacts with a button, or other control.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic menu</Typography>
<Typography className="text-base mb-32" component="div">A basic menu opens over the anchor element by default (this option can be <a href="#menu-positioning">changed</a> via props). When close to a screen edge, a basic menu vertically realigns to make sure that all menu items are completely visible.</Typography>
<Typography className="text-base mb-32" component="div">Choosing an option should immediately ideally commit the option and close the menu.</Typography>
<Typography className="text-base mb-32" component="div"><strong>Disambiguation</strong>: In contrast to simple menus, simple dialogs can present additional detail related to the options available for a list item or provide navigational or orthogonal actions related to the primary task. Although they can display the same content, simple menus are preferred over simple dialogs because simple menus are less disruptive to the user&#39;s current context.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicMenuRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Icon menu</Typography>
<Typography className="text-base mb-32" component="div">In desktop viewport, padding is increased to give more space to the menu.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="IconMenu.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={IconMenuRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Dense menu</Typography>
<Typography className="text-base mb-32" component="div">For the menu that has long list and long text, you can use the <code>{`dense`}</code> prop to reduce the padding and text size.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="DenseMenu.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={DenseMenuRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Selected menu</Typography>
<Typography className="text-base mb-32" component="div">If used for item selection, when opened, simple menus places the initial focus on the selected menu item.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Positioned menu</Typography>
<Typography className="text-base mb-32" component="div">Because the <code>{`Menu`}</code> component uses the <code>{`Popover`}</code> component to position itself, you can use the same <a href="/material-ui/react-popover/#anchor-playground">positioning props</a> to position it.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">MenuList composition</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`Menu`}</code> component uses the <code>{`Popover`}</code> component internally.
...
<Typography className="text-base mb-32" component="div">The primary responsibility of the <code>{`MenuList`}</code> component is to handle the focus.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Account menu</Typography>
<Typography className="text-base mb-32" component="div"><code>{`Menu`}</code> content can be mixed with other components like <code>{`Avatar`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="AccountMenu.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">The <code>{`MenuItem`}</code> is a wrapper around <code>{`ListItem`}</code> with some additional styles.
You can use the same list composition features with the <code>{`MenuItem`}</code> component:</Typography>
<Typography className="text-base mb-32" component="div">🎨 If you are looking for inspiration, you can check <a href="https://mui-treasury.com/?path=/docs/menu-introduction--docs">MUI Treasury&#39;s customization examples</a>.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Max height menu</Typography>
<Typography className="text-base mb-32" component="div">If the height of a menu prevents all menu items from being displayed, the menu can scroll internally.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="LongMenu.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Change transition</Typography>
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={FadeMenuRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Context menu</Typography>
<Typography className="text-base mb-32" component="div">Here is an example of a context menu. (Right click to open.)</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="ContextMenu.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">The package <a href="https://github.com/jcoreio/material-ui-popup-state"><code>{`material-ui-popup-state`}</code></a> that takes care of menu state for you in most cases.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
