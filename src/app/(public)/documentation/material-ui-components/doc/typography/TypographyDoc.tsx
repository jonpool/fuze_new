...
function TypographyDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Typography</Typography>
...
<Typography className="text-base mb-32" component="div">Fontsource can be configured to load specific subsets, weights, and styles. Material UI&#39;s default typography configuration relies only on the 300, 400, 500, and 700 font weights.</Typography>
</div>

<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Google Web Fonts</Typography>
<Typography className="text-base mb-32" component="div">To install Roboto through the Google Web Fonts CDN, add the following code inside your project&#39;s <head /> tag:</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Component</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Usage</Typography>
<Typography className="text-base mb-32" component="div">The Typography component follows the <a href="https://m2.material.io/design/typography/#type-scale">Material Design typographic scale</a> that provides a limited set of type sizes that work well together for a consistent layout.</Typography>
...
<Typography className="text-base mb-32" component="div">In some situations you might not be able to use the Typography component.
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Adding &amp; disabling variants</Typography>
<Typography className="text-base mb-32" component="div">In addition to using the default typography variants, you can add custom ones, or disable any you don&#39;t need. See the <a href="/material-ui/customization/typography/#adding-amp-disabling-variants">Adding &amp; disabling variants</a> page for more info.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Changing the semantic element</Typography>
<Typography className="text-base mb-32" component="div">The Typography component uses the <code>{`variantMapping`}</code> prop to associate a UI variant with a semantic element.
...
<Typography className="text-base mb-32" component="div">To change the underlying element for a one-off situation, like avoiding two <code>{`h1`}</code> elements in your page, use the <code>{`component`}</code> prop:</Typography>
...
<Typography className="text-base mb-32" component="div">To change the typography element mapping globally, <a href="/material-ui/customization/typography/#adding-amp-disabling-variants">use the theme</a>:</Typography>
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">System props</Typography>
<div className="border-1 p-16 rounded-xl my-12">
...
<Typography className="text-base mb-32" component="div">Key factors to follow for an accessible typography:</Typography>
