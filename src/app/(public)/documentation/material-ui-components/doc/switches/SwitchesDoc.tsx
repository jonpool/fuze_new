...
function SwitchesDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Switch</Typography>
<Typography className="description">Switches toggle the state of a single setting on or off.</Typography>

<Typography className="text-base mb-32" component="div">Switches are the preferred way to adjust settings on mobile.
The option that the switch controls, as well as the state it&#39;s in,
should be made clear from the corresponding inline label.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic switches</Typography>
...
<Typography className="text-base mb-32" component="div">You can provide a label to the <code>{`Switch`}</code> thanks to the <code>{`FormControlLabel`}</code> component.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">Use the <code>{`size`}</code> prop to change the size of the switch.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">You can control the switch with the <code>{`checked`}</code> and <code>{`onChange`}</code> props:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Switches with FormGroup</Typography>
<Typography className="text-base mb-32" component="div"><code>{`FormGroup`}</code> is a helpful wrapper used to group selection controls components that provides an easier API.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">🎨 If you are looking for inspiration, you can check <a href="https://mui-treasury.com/?path=/docs/switch-introduction--docs">MUI Treasury&#39;s customization examples</a>.</Typography>
