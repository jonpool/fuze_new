...
function TextFieldsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Text Field</Typography>
<Typography className="description">Text Fields let users enter and edit text.</Typography>

<Typography className="text-base mb-32" component="div">Text fields allow users to enter text into a UI. They typically appear in forms and dialogs.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic TextField</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`TextField`}</code> wrapper component is a complete form control including a label, input, and help text.
...
<Typography className="text-base mb-32" component="div">The standard variant of the Text Field is no longer documented in the <a href="https://m2.material.io/">Material Design guidelines</a>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Form props</Typography>
<Typography className="text-base mb-32" component="div">Standard form attributes are supported, for example <code>{`required`}</code>, <code>{`disabled`}</code>, <code>{`type`}</code>, etc. as well as a <code>{`helperText`}</code> which is used to give context about a field&#39;s input, such as how the input will be used.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Validation</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`error`}</code> prop toggles the error state.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Select</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`select`}</code> prop makes the text field use the <a href="/material-ui/react-select/">Select</a> component internally.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Icons</Typography>
<Typography className="text-base mb-32" component="div">There are multiple ways to display an icon with a text field.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Input Adornments</Typography>
<Typography className="text-base mb-32" component="div">The main way is with an <code>{`InputAdornment`}</code>.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">The <code>{`filled`}</code> variant input height can be further reduced by rendering the label outside of it.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Margin</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`margin`}</code> prop can be used to alter the vertical spacing of the text field.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Full width</Typography>
<Typography className="text-base mb-32" component="div"><code>{`fullWidth`}</code> can be used to make the input take up the full width of its container.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Uncontrolled vs. Controlled</Typography>
<Typography className="text-base mb-32" component="div">The component can be controlled or uncontrolled.</Typography>
<div className="border-1 p-16 rounded-xl my-12">
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Components</Typography>
<Typography className="text-base mb-32" component="div"><code>{`TextField`}</code> is composed of smaller components (
...
<Typography className="text-base mb-32" component="div">You might also have noticed that some native HTML input properties are missing from the <code>{`TextField`}</code> component.
This is on purpose.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Inputs</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="Inputs.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={InputsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Color</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`color`}</code> prop changes the highlight color of the text field when focused.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">Here are some examples of customizing the component.
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Using the styled API</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Using the theme style overrides API</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`styleOverrides`}</code> key to change any style injected by Material UI into the DOM.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">Customization does not stop at CSS.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">🎨 If you are looking for inspiration, you can check <a href="https://mui-treasury.com/?path=/docs/textField-introduction--docs">MUI Treasury&#39;s customization examples</a>.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2"><code>{`useFormControl`}</code></Typography>
<Typography className="text-base mb-32" component="div">For advanced customization use cases, a <code>{`useFormControl()`}</code> hook is exposed.
This hook returns the context value of the parent <code>{`FormControl`}</code> component.</Typography>
<Typography className="text-base mb-32" component="div"><strong>API</strong></Typography>
...
<Typography className="text-base mb-32" component="div"><strong>Returns</strong></Typography>
<Typography className="text-base mb-32" component="div"><code>{`value`}</code> (<em>object</em>):</Typography>
<ul className="space-y-16">
...
<Typography className="text-base mb-32" component="div"><strong>Example</strong></Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Performance</Typography>
<Typography className="text-base mb-32" component="div">Global styles for the auto-fill keyframes are injected and removed on each mount and unmount, respectively.
If you are loading a large number of Text Field components at once, it might be a good idea to change this default behavior by enabling <a href="/material-ui/api/input-base/#input-base-prop-disableInjectingGlobalStyles"><code>{`disableInjectingGlobalStyles`}</code></a> in <code>{`MuiInputBase`}</code>.
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Shrink</Typography>
<Typography className="text-base mb-32" component="div">The input label &quot;shrink&quot; state isn&#39;t always correct.
...
<Typography className="text-base mb-32" component="div"><img src="/material-ui-static/images/text-fields/shrink.png" alt="shrink"/></Typography>
<Typography className="text-base mb-32" component="div">To workaround the issue, you can force the &quot;shrink&quot; state of the label.</Typography>
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Floating label</Typography>
<Typography className="text-base mb-32" component="div">The floating label is absolutely positioned.
It won&#39;t impact the layout of the page.
Make sure that the input is larger than the label to display correctly.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">type=&quot;number&quot;</Typography>
...
<ul className="space-y-16">
<li><Typography className="text-base mb-32" component="div">it allows certain non-numeric characters (&#39;e&#39;, &#39;+&#39;, &#39;-&#39;, &#39;.&#39;) and silently discards others</Typography>
</li>
<li><Typography className="text-base mb-32" component="div">the functionality of scrolling to increment/decrement the number can cause accidental and hard-to-notice changes</Typography>
</li>
<li><Typography className="text-base mb-32" component="div">and more—see <a href="https://technology.blog.gov.uk/2020/02/24/why-the-gov-uk-design-system-team-changed-the-input-type-for-numbers/">Why the GOV.UK Design System team changed the input type for numbers</a> for a more detailed explanation of the limitations of <code>{`<input type="number">`}</code></Typography>
<Typography className="text-base mb-32" component="div">:::</Typography>
</li>
</ul>
<Typography className="text-base mb-32" component="div">If you need a text field with number validation, you can use Base UI&#39;s <a href="/base-ui/react-number-input/">Number Input</a> instead.</Typography>
<Typography className="text-base mb-32" component="div">You can follow <a href="https://github.com/mui/material-ui/issues/19154">this GitHub issue</a> to track the progress of introducing the Number Input component to Material UI.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Helper text</Typography>
<Typography className="text-base mb-32" component="div">The helper text prop affects the height of the text field. If two text fields are placed side by side, one with a helper text and one without, they will have different heights. For example:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">This can be fixed by passing a space character to the <code>{`helperText`}</code> prop:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Integration with 3rd party input libraries</Typography>
<Typography className="text-base mb-32" component="div">You can use third-party libraries to format an input.
...
<Typography className="text-base mb-32" component="div">The following demo uses the <a href="https://github.com/uNmAnNeR/imaskjs">react-imask</a> and <a href="https://github.com/s-yadav/react-number-format">react-number-format</a> libraries. The same concept could be applied to, for example <a href="https://github.com/mui/material-ui/issues/16037">react-stripe-element</a>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">The provided input component should expose a ref with a value that implements the following interface:</Typography>
...
<Typography className="text-base mb-32" component="div">In order for the text field to be accessible, <strong>the input should be linked to the label and the helper text</strong>. The underlying DOM nodes should have this structure:</Typography>
