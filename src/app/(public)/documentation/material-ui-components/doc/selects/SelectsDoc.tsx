...
function SelectsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Select</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic select</Typography>
<Typography className="text-base mb-32" component="div">Menus are positioned under their emitting elements, unless they are close to the bottom of the viewport.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicSelectRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Advanced features</Typography>
<Typography className="text-base mb-32" component="div">The Select component is meant to be interchangeable with a native <code>{`<select>`}</code> element.</Typography>
<Typography className="text-base mb-32" component="div">If you are looking for more advanced features, like combobox, multiselect, autocomplete, async or creatable support, head to the <a href="/material-ui/react-autocomplete/"><code>{`Autocomplete`}</code> component</a>.
It&#39;s meant to be an improved version of the &quot;react-select&quot; and &quot;downshift&quot; packages.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Props</Typography>
<Typography className="text-base mb-32" component="div">The Select component is implemented as a custom <code>{`<input>`}</code> element of the <a href="/material-ui/api/input-base/">InputBase</a>.
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Filled and standard variants</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Labels and helper text</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
:::</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Auto width</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Small Size</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="SelectSmall.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={SelectSmallRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Other props</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Native select</Typography>
<Typography className="text-base mb-32" component="div">As the user experience can be improved on mobile using the native select of the platform,
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">TextField</Typography>
...
<Typography className="text-base mb-32" component="div">The first step is to style the <code>{`InputBase`}</code> component.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">🎨 If you are looking for inspiration, you can check <a href="https://mui-treasury.com/?path=/docs/select-introduction--docs">MUI Treasury&#39;s customization examples</a>.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Multiple select</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`Select`}</code> component can handle multiple selections.
It&#39;s enabled with the <code>{`multiple`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div">Like with the single selection, you can pull out the new value by accessing <code>{`event.target.value`}</code> in the <code>{`onChange`}</code> callback. It&#39;s always an array.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Default</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Checkmarks</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Chip</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Placeholder</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Native</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Controlling the open state</Typography>
<Typography className="text-base mb-32" component="div">You can control the open state of the select with the <code>{`open`}</code> prop. Alternatively, it is also possible to set the initial (uncontrolled) open state of the component with the <code>{`defaultOpen`}</code> prop.</Typography>
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">With a dialog</Typography>
<Typography className="text-base mb-32" component="div">While it&#39;s discouraged by the Material Design guidelines, you can use a select inside a dialog.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={DialogSelectRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Grouping</Typography>
<Typography className="text-base mb-32" component="div">Display categories with the <code>{`ListSubheader`}</code> component or the native <code>{`<optgroup>`}</code> element.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">You have two options for solving this:
...
<Typography className="text-base mb-32" component="div">Option 2: Place a <code>{`muiSkipListHighlight`}</code> prop on each instance of your component.
...
<Typography className="text-base mb-32" component="div">We recommend the first option as it doesn&#39;t require updating all the usage sites of the component.</Typography>
<Typography className="text-base mb-32" component="div">Keep in mind this is <strong>only necessary</strong> if you wrap the ListSubheader in a custom component.
...
<Typography className="text-base mb-32" component="div">Alternatively a <code>{`TextField`}</code> with an <code>{`id`}</code> and <code>{`label`}</code> creates the proper markup and
...
<Typography className="text-base mb-32" component="div">For a <a href="#native-select">native select</a>, you should mention a label by giving the value of the <code>{`id`}</code> attribute of the select element to the <code>{`InputLabel`}</code>&#39;s <code>{`htmlFor`}</code> attribute:</Typography>
