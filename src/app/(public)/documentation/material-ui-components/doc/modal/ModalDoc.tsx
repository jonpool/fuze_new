...
function ModalDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Modal</Typography>
...
<Typography className="text-base mb-32" component="div">The component renders its <code>{`children`}</code> node in front of a backdrop component.
...
<Typography className="text-base mb-32" component="div">The term &quot;modal&quot; is sometimes used to mean &quot;dialog&quot;, but this is a misnomer.
...
<Typography className="text-base mb-32" component="div">If you are creating a modal dialog, you probably want to use the <a href="/material-ui/react-dialog/">Dialog</a> component rather than directly using Modal.
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic modal</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicModalRaw}
                    /></Typography>
<Typography className="text-base mb-32" component="div">Notice that you can disable the outline (often blue or gold) with the <code>{`outline: 0`}</code> CSS property.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Nested modal</Typography>
<Typography className="text-base mb-32" component="div">Modals can be nested, for example a select within a dialog, but stacking of more than two modals, or any two modals with a backdrop is discouraged.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="NestedModal.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">The open/close state of the modal can be animated with a transition component.
...
<Typography className="text-base mb-32" component="div">Modal has built-in support for <a href="https://github.com/reactjs/react-transition-group">react-transition-group</a>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">Alternatively, you can use <a href="https://github.com/pmndrs/react-spring">react-spring</a>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="SpringModal.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">The content of modal is unmounted when closed.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">As with any performance optimization, this is not a silver bullet.
Be sure to identify bottlenecks first, and then try out these optimization strategies.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Server-side modal</Typography>
<Typography className="text-base mb-32" component="div">React <a href="https://github.com/facebook/react/issues/13097">doesn&#39;t support</a> the <a href="https://react.dev/reference/react-dom/createPortal"><code>{`createPortal()`}</code></a> API on the server.
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Focus trap</Typography>
<Typography className="text-base mb-32" component="div">The modal moves the focus back to the body of the component if the focus tries to escape it.</Typography>
<Typography className="text-base mb-32" component="div">This is done for accessibility purposes. However, it might create issues.
In the event the users need to interact with another part of the page, for example with a chatbot window, you can disable the behavior:</Typography>
...
<Typography className="text-base mb-32" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/">https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/</a>)</Typography>
<ul className="space-y-16">
<li><Typography className="text-base mb-32" component="div">Be sure to add <code>{`aria-labelledby="id..."`}</code>, referencing the modal title, to the <code>{`Modal`}</code>.
...
<li><Typography className="text-base mb-32" component="div">The <a href="https://www.w3.org/WAI/ARIA/apg/patterns/dialog-modal/examples/dialog/">WAI-ARIA Authoring Practices</a> can help you set the initial focus on the most relevant element, based on your modal content.</Typography>
</li>
<li><Typography className="text-base mb-32" component="div">Keep in mind that a &quot;modal window&quot; overlays on either the primary window or another modal window. Windows under a modal are <strong>inert</strong>. That is, users cannot interact with content outside an active modal window. This might create <a href="#focus-trap">conflicting behaviors</a>.</Typography>
</li>
</ul>
