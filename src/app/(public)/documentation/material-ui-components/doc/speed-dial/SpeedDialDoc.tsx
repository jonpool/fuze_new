...
function SpeedDialDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Speed Dial</Typography>
...
<Typography className="text-base mb-32" component="div">If more than six actions are needed, something other than a FAB should be used to present them.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic speed dial</Typography>
<Typography className="text-base mb-32" component="div">The floating action button can display related actions.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Playground</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Controlled speed dial</Typography>
<Typography className="text-base mb-32" component="div">The open state of the component can be controlled with the <code>{`open`}</code>/<code>{`onOpen`}</code>/<code>{`onClose`}</code> props.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Custom close icon</Typography>
<Typography className="text-base mb-32" component="div">You can provide an alternate icon for the closed and open states using the <code>{`icon`}</code> and <code>{`openIcon`}</code> props
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Persistent action tooltips</Typography>
<Typography className="text-base mb-32" component="div">The SpeedDialActions tooltips can be displayed persistently so that users don&#39;t have to long-press to see the tooltip on touch devices.</Typography>
<Typography className="text-base mb-32" component="div">It is enabled here across all devices for demo purposes, but in production it could use the <code>{`isTouch`}</code> logic to conditionally set the prop.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mt-12 mb-10" component="h4">Required</Typography>
...
<Typography className="text-base mt-12 mb-10" component="h4">Provided</Typography>
<ul className="space-y-16">
