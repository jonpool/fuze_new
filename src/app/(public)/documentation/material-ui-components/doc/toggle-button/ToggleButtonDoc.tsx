...
function ToggleButtonDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Toggle Button</Typography>
<Typography className="description">A Toggle Button can be used to group related options.</Typography>

<Typography className="text-base mb-32" component="div">To emphasize groups of related Toggle buttons,
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Exclusive selection</Typography>
<Typography className="text-base mb-32" component="div">With exclusive selection, selecting one option deselects any other.</Typography>
<Typography className="text-base mb-32" component="div">In this example, text justification toggle buttons present options for left, center, right, and fully justified text (disabled), with only one item available for selection at a time.</Typography>
<Typography className="text-base mb-32" component="div"><strong>Note</strong>: Exclusive selection does not enforce that a button must be active. For that effect see <a href="#enforce-value-set">enforce value set</a>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Multiple selection</Typography>
<Typography className="text-base mb-32" component="div">Multiple selection allows for logically-grouped options, like bold, italic, and underline, to have multiple options selected.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Vertical buttons</Typography>
<Typography className="text-base mb-32" component="div">The buttons can be stacked vertically with the <code>{`orientation`}</code> prop set to &quot;vertical&quot;.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Enforce value set</Typography>
<Typography className="text-base mb-32" component="div">If you want to enforce that at least one button must be active, you can adapt your handleChange function.</Typography>
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Standalone toggle button</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">At present, toggle buttons are in DOM order. Navigate between them with the tab key. The button behavior follows standard keyboard semantics.</Typography>
