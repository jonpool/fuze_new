...
function AvatarsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Avatar</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Image avatars</Typography>
<Typography className="text-base mb-32" component="div">Image avatars can be created by passing standard <code>{`img`}</code> props <code>{`src`}</code> or <code>{`srcSet`}</code> to the component.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={ImageAvatarsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Letter avatars</Typography>
<Typography className="text-base mb-32" component="div">Avatars containing simple characters can be created by passing a string as <code>{`children`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">You can use different background colors for the avatar.
...
<Typography className="text-base mb-32" component="div">You can change the size of the avatar with the <code>{`height`}</code> and <code>{`width`}</code> CSS properties.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="SizeAvatars.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={SizeAvatarsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Icon avatars</Typography>
<Typography className="text-base mb-32" component="div">Icon avatars are created by passing an icon as <code>{`children`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="IconAvatars.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={IconAvatarsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Variants</Typography>
<Typography className="text-base mb-32" component="div">If you need square or rounded avatars, use the <code>{`variant`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Fallbacks</Typography>
<Typography className="text-base mb-32" component="div">If there is an error loading the avatar image, the component falls back to an alternative in the following order:</Typography>
...
<Typography className="text-base mb-32" component="div"><code>{`AvatarGroup`}</code> renders its children as a stack. Use the <code>{`max`}</code> prop to limit the number of avatars.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={GroupAvatarsRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Total avatars</Typography>
<Typography className="text-base mb-32" component="div">If you need to control the total number of avatars not shown, you can use the <code>{`total`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={TotalAvatarsRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Custom surplus</Typography>
<Typography className="text-base mb-32" component="div">Set the <code>{`renderSurplus`}</code> prop as a callback to customize the surplus avatar. The callback will receive the surplus number as an argument based on the children and the <code>{`max`}</code> prop, and should return a <code>{`React.ReactNode`}</code>.</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`renderSurplus`}</code> prop is useful when you need to render the surplus based on the data sent from the server.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
