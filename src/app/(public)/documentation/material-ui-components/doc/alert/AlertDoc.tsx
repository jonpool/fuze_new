...
function AlertDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Alert</Typography>
...
<Typography className="text-base mb-32" component="div">Alerts give users brief and potentially time-sensitive information in an unobtrusive manner.</Typography>
<Typography className="text-base mb-32" component="div">The Material UI Alert component includes several props for quickly customizing its styles to provide immediate visual cues about its contents.</Typography>
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Usage</Typography>
<Typography className="text-base mb-32" component="div">A key trait of the alert pattern is that <a href="https://www.w3.org/WAI/ARIA/apg/patterns/alert/">it should not interrupt the user&#39;s experience</a> of the app.
...
Use the Material UI <a href="/material-ui/react-dialog/">Dialog</a> component if you need this behavior.</Typography>
...
<Typography className="text-base mb-32" component="div">The Alert component wraps around its content, and stretches to fill its enclosing container.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Severity</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`severity`}</code> prop accepts four values representing different states—<code>{`success`}</code> (the default), <code>{`info`}</code>, <code>{`warning`}</code>, and <code>{`error`}</code>–with corresponding icon and color combinations for each:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="BasicAlerts.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={BasicAlertsRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Variants</Typography>
<Typography className="text-base mb-32" component="div">The Alert component comes with two alternative style options—<code>{`filled`}</code> and <code>{`outlined`}</code>—which you can set using the <code>{`variant`}</code> prop.</Typography>
<Typography className="text-base mt-12 mb-10" component="h4">Filled</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={FilledAlertsRaw}
                    /></Typography>
<Typography className="text-base mt-12 mb-10" component="h4">Outlined</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">Check out the <a href="/material-ui/react-snackbar/#customization">Snackbar—customization</a> doc for an example of how to use these two components together.
:::</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Color</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`color`}</code> prop to override the default color for the specified <a href="#severity"><code>{`severity`}</code></a>—for instance, to apply <code>{`warning`}</code> colors to a <code>{`success`}</code> Alert:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="ColorAlerts.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={ColorAlertsRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Actions</Typography>
<Typography className="text-base mb-32" component="div">Add an action to your Alert with the <code>{`action`}</code> prop.
...
<Typography className="text-base mb-32" component="div">If you provide an <code>{`onClose`}</code> callback to the Alert without setting the <code>{`action`}</code> prop, the component will display a close icon (&#x2715;) by default.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={ActionAlertsRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Icons</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`icon`}</code> prop to override an Alert&#39;s icon.
...
<Typography className="text-base mb-32" component="div">If you need to override all instances of an icon for a given <a href="#severity"><code>{`severity`}</code></a>, you can use the <code>{`iconMapping`}</code> prop instead.
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Titles</Typography>
<Typography className="text-base mb-32" component="div">To add a title to an Alert, import the Alert Title component:</Typography>
...
<Typography className="text-base mb-32" component="div">You can nest this component above the message in your Alert for a neatly styled and properly aligned title, as shown below:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Transitions</Typography>
<Typography className="text-base mb-32" component="div">You can use <a href="/material-ui/transitions/">Transition components</a> like <a href="/material-ui/transitions/#collapse">Collapse</a> to add motion to an Alert&#39;s entrance and exit.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">Here are some factors to consider to ensure that your Alert is accessible:</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Anatomy</Typography>
<Typography className="text-base mb-32" component="div">The Alert component is composed of a root <a href="/material-ui/react-paper/">Paper</a> component (which renders as a <code>{`<div>`}</code>) that houses an icon, a message, and an optional <a href="#actions">action</a>:</Typography>
