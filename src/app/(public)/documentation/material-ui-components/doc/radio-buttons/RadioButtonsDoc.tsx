...
function RadioButtonsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Radio Group</Typography>
<Typography className="description">The Radio Group allows the user to select one option from a set.</Typography>

<Typography className="text-base mb-32" component="div">Use radio buttons when the user needs to see all available options.
...
<Typography className="text-base mb-32" component="div">Radio buttons should have the most commonly used option selected by default.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Radio group</Typography>
<Typography className="text-base mb-32" component="div"><code>{`RadioGroup`}</code> is a helpful wrapper used to group <code>{`Radio`}</code> components that provides an easier API, and proper keyboard accessibility to the group.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Direction</Typography>
<Typography className="text-base mb-32" component="div">To lay out the buttons horizontally, set the <code>{`row`}</code> prop:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Controlled</Typography>
<Typography className="text-base mb-32" component="div">You can control the radio with the <code>{`value`}</code> and <code>{`onChange`}</code> props:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Standalone radio buttons</Typography>
<Typography className="text-base mb-32" component="div"><code>{`Radio`}</code> can also be used standalone, without the RadioGroup wrapper.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">Use the <code>{`size`}</code> prop or customize the font size of the svg icons to change the size of the radios.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Label placement</Typography>
<Typography className="text-base mb-32" component="div">You can change the placement of the label with the <code>{`FormControlLabel`}</code> component&#39;s <code>{`labelPlacement`}</code> prop:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Show error</Typography>
<Typography className="text-base mb-32" component="div">In general, radio buttons should have a value selected by default. If this is not the case, you can display an error if no value is selected when the form is submitted:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="ErrorRadios.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2"><code>{`useRadioGroup`}</code></Typography>
<Typography className="text-base mb-32" component="div">For advanced customization use cases, a <code>{`useRadioGroup()`}</code> hook is exposed.
It returns the context value of the parent radio group.
The Radio component uses this hook internally.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">API</Typography>
...
<Typography className="text-base mt-12 mb-10" component="h4">Example</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">When to use</Typography>
<ul className="space-y-16">
...
<Typography className="text-base mb-32" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/radio/">https://www.w3.org/WAI/ARIA/apg/patterns/radio/</a>)</Typography>
<ul className="space-y-16">
<li><Typography className="text-base mb-32" component="div">All form controls should have labels, and this includes radio buttons, checkboxes, and switches. In most cases, this is done by using the <code>{`<label>`}</code> element (<a href="/material-ui/api/form-control-label/">FormControlLabel</a>).</Typography>
</li>
<li><Typography className="text-base mb-32" component="div">When a label can&#39;t be used, it&#39;s necessary to add an attribute directly to the input component.
In this case, you can apply the additional attribute (for example <code>{`aria-label`}</code>, <code>{`aria-labelledby`}</code>, <code>{`title`}</code>) via the <code>{`inputProps`}</code> property.</Typography>
</li>
</ul>
