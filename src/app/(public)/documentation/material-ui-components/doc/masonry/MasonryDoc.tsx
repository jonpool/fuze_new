...
function MasonryDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Masonry</Typography>
...
<Typography className="text-base mb-32" component="div">Masonry maintains a list of content blocks with a consistent width but different height.
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic masonry</Typography>
<Typography className="text-base mb-32" component="div">A simple example of a <code>{`Masonry`}</code>. <code>{`Masonry`}</code> is a container for one or more items. It can receive any element including <code>{`<div />`}</code> and <code>{`<img //>`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicMasonryRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Image masonry</Typography>
<Typography className="text-base mb-32" component="div">This example demonstrates the use of <code>{`Masonry`}</code> for images. <code>{`Masonry`}</code> orders its children by row.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={ImageMasonryRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Items with variable height</Typography>
<Typography className="text-base mb-32" component="div">This example demonstrates the use of <code>{`Masonry`}</code> for items with variable height.
...
<Typography className="text-base mb-32" component="div">This example demonstrates the use of the <code>{`columns`}</code> to configure the number of columns of a <code>{`Masonry`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={FixedColumnsRaw}
                    /></Typography>
<Typography className="text-base mb-32" component="div"><code>{`columns`}</code> accepts responsive values:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">This example demonstrates the use of the <code>{`spacing`}</code> to configure the spacing between items.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={FixedSpacingRaw}
                    /></Typography>
<Typography className="text-base mb-32" component="div"><code>{`spacing`}</code> accepts responsive values:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Sequential</Typography>
<Typography className="text-base mb-32" component="div">This example demonstrates the use of the <code>{`sequential`}</code> to configure the sequential order.
With <code>{`sequential`}</code> enabled, items are added in order from left to right rather than adding to the shortest column.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="Sequential.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={SequentialRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Server-side rendering</Typography>
<Typography className="text-base mb-32" component="div">This example demonstrates the use of the <code>{`defaultHeight`}</code>, <code>{`defaultColumns`}</code> and <code>{`defaultSpacing`}</code>, which are used to
support server-side rendering.</Typography>
<div className="border-1 p-16 rounded-xl my-12">

<Typography className="text-base mb-32" component="div"><code>{`defaultHeight`}</code> should be large enough to render all rows. Also, it is worth mentioning that items are not added to the shortest column in case of server-side rendering.</Typography>
</div>
