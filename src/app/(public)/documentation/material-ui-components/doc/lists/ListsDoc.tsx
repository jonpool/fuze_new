...
function ListsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Lists</Typography>
<Typography className="description">Lists are continuous, vertical indexes of text or images.</Typography>

<Typography className="text-base mb-32" component="div">Lists are a continuous group of text or images. They are composed of items containing primary and supplemental actions, which are represented by icons and text.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Introduction</Typography>
<Typography className="text-base mb-32" component="div">Lists present information in a concise, easy-to-follow format through a continuous, vertical index of text or images.</Typography>
<Typography className="text-base mb-32" component="div">Material UI Lists are implemented using a collection of related components:</Typography>
<ul className="space-y-16">
<li>List: a wrapper for list items. Renders as a <code>{`<ul className="space-y-16">`}</code> by default.</li>
<li>List Item: a common list item. Renders as an <code>{`<li>`}</code> by default.</li>
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicListRaw}
                    /></Typography>
<Typography className="text-base mb-32" component="div">The last item of the previous demo shows how you can render a link:</Typography>
...
<Typography className="text-base mb-32" component="div">You can find a <a href="/material-ui/integrations/routing/#list">demo with React Router following this section</a> of the documentation.</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Nested List</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="NestedList.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={NestedListRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Folder List</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="FolderList.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Selected ListItem</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Align list items</Typography>
<Typography className="text-base mb-32" component="div">When displaying three lines or more, the avatar is not aligned at the top.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">List Controls</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Checkbox</Typography>
<Typography className="text-base mb-32" component="div">A checkbox can either be a primary action or a secondary action.</Typography>
<Typography className="text-base mb-32" component="div">The checkbox is the primary action and the state indicator for the list item. The comment button is a secondary action and a separate target.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={CheckboxListRaw}
                    /></Typography>
<Typography className="text-base mb-32" component="div">The checkbox is the secondary action for the list item and a separate target.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Switch</Typography>
<Typography className="text-base mb-32" component="div">The switch is the secondary action and a separate target.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Sticky subheader</Typography>
<Typography className="text-base mb-32" component="div">Upon scrolling, subheaders remain pinned to the top of the screen until pushed off screen by the next subheader.
This feature relies on CSS sticky positioning.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Inset List Item</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`inset`}</code> prop enables a list item that does not have a leading icon or avatar to align correctly with items that do.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="InsetList.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={InsetListRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Gutterless list</Typography>
<Typography className="text-base mb-32" component="div">When rendering a list within a component that defines its own gutters, <code>{`ListItem`}</code> gutters can be disabled with <code>{`disableGutters`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Virtualized List</Typography>
<Typography className="text-base mb-32" component="div">In the following example, we demonstrate how to use <a href="https://github.com/bvaughn/react-window">react-window</a> with the <code>{`List`}</code> component.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">The use of <a href="https://github.com/bvaughn/react-window">react-window</a> when possible is encouraged.
