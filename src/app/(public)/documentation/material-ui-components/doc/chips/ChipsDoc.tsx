...
function ChipsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Chip</Typography>
<Typography className="description">Chips are compact elements that represent an input, attribute, or action.</Typography>

<Typography className="text-base mb-32" component="div">Chips allow users to enter information, make selections, filter content, or trigger actions.</Typography>
<Typography className="text-base mb-32" component="div">While included here as a standalone component, the most common use will
be in some form of input, so some of the behavior demonstrated here is
not shown in context.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic chip</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`Chip`}</code> component supports outlined and filled styling.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicChipsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Chip actions</Typography>
<Typography className="text-base mb-32" component="div">You can use the following actions.</Typography>
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Clickable</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Deletable</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Clickable and deletable</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Clickable link</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Custom delete icon</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Chip adornments</Typography>
<Typography className="text-base mb-32" component="div">You can add ornaments to the beginning of the component.</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`avatar`}</code> prop to add an avatar or use the <code>{`icon`}</code> prop to add an icon.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Avatar chip</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="AvatarChips.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={AvatarChipsRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Icon chip</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="IconChips.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={IconChipsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Color chip</Typography>
<Typography className="text-base mb-32" component="div">You can use the <code>{`color`}</code> prop to define a color from theme palette.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="ColorChips.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={ColorChipsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Sizes chip</Typography>
<Typography className="text-base mb-32" component="div">You can use the <code>{`size`}</code> prop to define a small Chip.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="SizesChips.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={SizesChipsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Multiline chip</Typography>
<Typography className="text-base mb-32" component="div">By default, Chips displays labels only in a single line.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Chip array</Typography>
<Typography className="text-base mb-32" component="div">An example of rendering multiple chips from an array of values.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={ChipsArrayRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Chip playground</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Accessibility</Typography>
<Typography className="text-base mb-32" component="div">If the Chip is deletable or clickable then it is a button in tab order. When the Chip is focused (for example when tabbing) releasing (<code>{`keyup`}</code> event) <code>{`Backspace`}</code> or <code>{`Delete`}</code> will call the <code>{`onDelete`}</code> handler while releasing <code>{`Escape`}</code> will blur the Chip.</Typography>
