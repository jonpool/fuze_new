...
function PopoverDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Popover</Typography>
<Typography className="description">A Popover can be used to display some content on top of another.</Typography>

<Typography className="text-base mb-32" component="div">Things to know when using the <code>{`Popover`}</code> component:</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic Popover</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicPopoverRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Anchor playground</Typography>
<Typography className="text-base mb-32" component="div">Use the radio buttons to adjust the <code>{`anchorOrigin`}</code> and <code>{`transformOrigin`}</code> positions.
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Mouse hover interaction</Typography>
<Typography className="text-base mb-32" component="div">This demo demonstrates how to use the <code>{`Popover`}</code> component with <code>{`mouseenter`}</code> and <code>{`mouseleave`}</code> events to achieve popover behavior.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">The value of the <code>{`anchorEl`}</code> prop can be a reference to a fake DOM element.
...
<Typography className="text-base mb-32" component="div">Highlight part of the text to see the popover:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">For more information on the virtual element&#39;s properties, see the following resources:</Typography>
<ul className="space-y-16">
...
<Typography className="text-base mb-32" component="div">The package <a href="https://github.com/jcoreio/material-ui-popup-state"><code>{`material-ui-popup-state`}</code></a> that takes care of popover state for you in most cases.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
