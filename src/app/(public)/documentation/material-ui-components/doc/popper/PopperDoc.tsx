...
<Typography className="text-base mb-32" component="div">The open/close state of the popper can be animated with a render prop child and a transition component.
...
<Typography className="text-base mb-32" component="div">Popper has built-in support for <a href="https://github.com/reactjs/react-transition-group">react-transition-group</a>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={SpringPopperRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Positioned popper</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Scroll playground</Typography>
...
<Typography className="text-base mb-32" component="div">Highlight part of the text to see the popper:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">The package <a href="https://github.com/jcoreio/material-ui-popup-state"><code>{`material-ui-popup-state`}</code></a> that takes care of popper state for you in most cases.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
