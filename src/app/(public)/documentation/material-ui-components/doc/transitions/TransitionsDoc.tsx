...
function TransitionsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Transitions</Typography>
<Typography className="description">Transitions help to make a UI expressive and easy to use.</Typography>

<Typography className="text-base mb-32" component="div">Material UI provides transitions that can be used to introduce some basic <a href="https://m2.material.io/design/motion/">motion</a> to your applications.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Collapse</Typography>
<Typography className="text-base mb-32" component="div">Expand from the start edge of the child element.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Fade</Typography>
<Typography className="text-base mb-32" component="div">Fade in from transparent to opaque.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="SimpleFade.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={SimpleFadeRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Grow</Typography>
<Typography className="text-base mb-32" component="div">Expands outwards from the center of the child element, while also fading in from transparent to opaque.</Typography>
<Typography className="text-base mb-32" component="div">The second example demonstrates how to change the <code>{`transform-origin`}</code>, and conditionally applies
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={SimpleGrowRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Slide</Typography>
<Typography className="text-base mb-32" component="div">Slide in from the edge of the screen.
The <code>{`direction`}</code> prop controls which edge of the screen the transition starts from.</Typography>
<Typography className="text-base mb-32" component="div">The Transition component&#39;s <code>{`mountOnEnter`}</code> prop prevents the child component from being mounted
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={SimpleSlideRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Slide relative to a container</Typography>
<Typography className="text-base mb-32" component="div">The Slide component also accepts <code>{`container`}</code> prop, which is a reference to a DOM node.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Zoom</Typography>
<Typography className="text-base mb-32" component="div">Expand outwards from the center of the child element.</Typography>
<Typography className="text-base mb-32" component="div">This example also demonstrates how to delay the enter transition.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="SimpleZoom.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={SimpleZoomRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Child requirement</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">TransitionGroup</Typography>
<Typography className="text-base mb-32" component="div">To animate a component when it is mounted or unmounted, you can use the <a href="https://reactcommunity.org/react-transition-group/transition-group/"><code>{`TransitionGroup`}</code></a> component from <em>react-transition-group</em>.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">TransitionComponent prop</Typography>
<Typography className="text-base mb-32" component="div">Some Material UI components use these transitions internally. These accept a <code>{`TransitionComponent`}</code> prop to customize the default transition.
...
<Typography className="text-base mb-32" component="div">For more information on creating a custom transition, visit the <em>react-transition-group</em> <a href="https://reactcommunity.org/react-transition-group/transition/"><code>{`Transition`}</code> documentation</a>.
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Performance &amp; SEO</Typography>
<Typography className="text-base mb-32" component="div">The content of transition component is mounted by default even if <code>{`in={false}`}</code>.
