...
function ImageListDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Image List</Typography>
<Typography className="description">The Image List displays a collection of images in an organized grid.</Typography>

<Typography className="text-base mb-32" component="div">Image lists represent a collection of items in a repeated pattern. They help improve the visual comprehension of the content they hold.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Standard image list</Typography>
<Typography className="text-base mb-32" component="div">Standard image lists are best for items of equal importance. They have a uniform container size, ratio, and spacing.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Quilted image list</Typography>
<Typography className="text-base mb-32" component="div">Quilted image lists emphasize certain items over others in a collection. They create hierarchy using varied container sizes and ratios.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Woven image list</Typography>
<Typography className="text-base mb-32" component="div">Woven image lists use alternating container ratios to create a rhythmic layout. A woven image list is best for browsing peer content.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Masonry image list</Typography>
<Typography className="text-base mb-32" component="div">Masonry image lists use dynamically sized container heights that reflect the aspect ratio of each image. This image list is best used for browsing uncropped peer content.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Image list with title bars</Typography>
<Typography className="text-base mb-32" component="div">This example demonstrates the use of the <code>{`ImageListItemBar`}</code> to add an overlay to each item.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Title bar below image (standard)</Typography>
<Typography className="text-base mb-32" component="div">The title bar can be placed below the image.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Title bar below image (masonry)</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Custom image list</Typography>
<Typography className="text-base mb-32" component="div">In this example the items have a customized titlebar, positioned at the top and with a custom gradient <code>{`titleBackground`}</code>.
