...
function LinksDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Links</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic links</Typography>
<Typography className="text-base mb-32" component="div">The Link component is built on top of the <a href="/material-ui/api/typography/">Typography</a> component, meaning that you can use its props.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={LinksRaw}
                    /></Typography>
<Typography className="text-base mb-32" component="div">However, the Link component has some different default props than the Typography component:</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Underline</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`underline`}</code> prop can be used to set the underline behavior. The default is <code>{`always`}</code>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Security</Typography>
<Typography className="text-base mb-32" component="div">When you use <code>{`target="_blank"`}</code> with Links, it is <a href="https://developers.google.com/web/tools/lighthouse/audits/noopener">recommended</a> to always set <code>{`rel="noopener"`}</code> or <code>{`rel="noreferrer"`}</code> when linking to third party content.</Typography>
<ul className="space-y-16">
...
Here is a <a href="/material-ui/integrations/routing/#link">more detailed guide</a>.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Accessibility</Typography>
<Typography className="text-base mb-32" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/link/">https://www.w3.org/WAI/ARIA/apg/patterns/link/</a>)</Typography>
<ul className="space-y-16">
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={ButtonLinkRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Keyboard accessibility</Typography>
<ul className="space-y-16">
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Screen reader accessibility</Typography>
<ul className="space-y-16">
