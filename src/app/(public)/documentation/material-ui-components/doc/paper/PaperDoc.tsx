...
function PaperDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Paper</Typography>
...
<Typography className="text-base mb-32" component="div">In Material Design, surface components and shadow styles are heavily influenced by their real-world physical counterparts.</Typography>
<Typography className="text-base mb-32" component="div">Material UI implements this concept with the Paper component, a container-like surface that features the <a href="#elevation"><code>{`elevation`}</code></a> prop for pulling box-shadow values from the theme.</Typography>
...
<Typography className="text-base mb-32" component="div">If you just need a generic container, you may prefer to use the <a href="/material-ui/react-box/">Box</a> or <a href="/material-ui/react-container/">Container</a> components.
:::</Typography>
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Elevation</Typography>
<Typography className="text-base mb-32" component="div">Use the <code>{`elevation`}</code> prop to establish hierarchy through the use of shadows.
...
<Typography className="text-base mb-32" component="div">In dark mode, increasing the elevation also makes the background color lighter.
...
<Typography className="text-base mb-32" component="div">Set the <code>{`variant`}</code> prop to <code>{`"outlined"`}</code> for a flat, outlined Paper with no shadows:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="Variants.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={VariantsRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Corners</Typography>
<Typography className="text-base mb-32" component="div">The Paper component features rounded corners by default.
...
<Typography className="text-base mb-32" component="div">The Paper component is composed of a single root <code>{`<div>`}</code> that wraps around its contents:</Typography>
