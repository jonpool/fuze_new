...
function CardsDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Card</Typography>
...
<Typography className="text-base mb-32" component="div">Cards are surfaces that display content and actions on a single topic.
...
:::</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Outlined Card</Typography>
<Typography className="text-base mb-32" component="div">Set <code>{`variant="outlined"`}</code> to render an outlined card.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={OutlinedCardRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Complex Interaction</Typography>
<Typography className="text-base mb-32" component="div">On desktop, card content can expand. (Click the downward chevron to view the recipe.)</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Media</Typography>
<Typography className="text-base mb-32" component="div">Example of a card using an image to reinforce the content.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="MediaCard.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">A card can also offer supplemental actions which should stand detached from the main action area in order to avoid event overlap.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">UI Controls</Typography>
<Typography className="text-base mb-32" component="div">Supplemental actions within the card are explicitly called out using icons, text, and UI controls, typically placed at the bottom of the card.</Typography>
<Typography className="text-base mb-32" component="div">Here&#39;s an example of a media control card.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">🎨 If you are looking for inspiration, you can check <a href="https://mui-treasury.com/?path=/docs/card-introduction--docs">MUI Treasury&#39;s customization examples</a>.</Typography>
