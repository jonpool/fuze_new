...
function RatingDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Rating</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Basic rating</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={BasicRatingRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Rating precision</Typography>
<Typography className="text-base mb-32" component="div">The rating can display any float number with the <code>{`value`}</code> prop.
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={HalfRatingRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Hover feedback</Typography>
<Typography className="text-base mb-32" component="div">You can display a label on hover to help the user pick the correct rating value.
...
<Typography className="text-base mb-32" component="div">For larger or smaller ratings use the <code>{`size`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="RatingSize.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">The rating is implemented with a radio group, set <code>{`highlightSelectedOnly`}</code> to restore the natural behavior.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">(<a href="https://www.w3.org/WAI/tutorials/forms/custom-controls/#a-star-rating">WAI tutorial</a>)</Typography>
...
Be sure to provide a suitable function to the <code>{`getLabelText`}</code> prop when the page is in a language other than English. You can use the <a href="/material-ui/guides/localization/">included locales</a>, or provide your own.</li>
...
<Typography className="text-base mb-32" component="div">The read only rating has a role of &quot;img&quot;, and an aria-label that describes the displayed rating.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Keyboard</Typography>
<Typography className="text-base mb-32" component="div">Because the rating component uses radio buttons, keyboard interaction follows the native browser behavior. Tab will focus the current rating, and cursor keys control the selected rating.</Typography>
<Typography className="text-base mb-32" component="div">The read only rating is not focusable.</Typography>
