...
function AutocompleteDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Autocomplete</Typography>
...
<Typography className="text-base mb-32" component="div">The widget is useful for setting the value of a single-line textbox in one of two types of scenarios:</Typography>
<ol>
<li>The value for the textbox must be chosen from a predefined set of allowed values, for example a location field must contain a valid location name: <a href="#combo-box">combo box</a>.</li>
<li>The textbox may contain any arbitrary value, but it is advantageous to suggest possible values to the user, for example a search field may suggest similar or previous searches to save the user time: <a href="#free-solo">free solo</a>.</li>
</ol>
...
<Typography className="text-base mb-32" component="div">for instance:</Typography>
...
<Typography className="text-base mb-32" component="div">However, you can use different structures by providing a <code>{`getOptionLabel`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div">If your options are objects, you must provide the <code>{`isOptionEqualToValue`}</code> prop to ensure correct selection and highlighting. By default, it uses strict equality to compare options with the current value.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Playground</Typography>
<Typography className="text-base mb-32" component="div">Each of the following examples demonstrates one feature of the Autocomplete component.</Typography>
...
<Typography className="text-base mb-32" component="div">Choose one of the 248 countries.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">The component has two states that can be controlled:</Typography>
<ol>
...
<Typography className="text-base mb-32" component="div">These two states are isolated, and should be controlled independently.</Typography>
...
<Typography className="text-base mb-32" component="div">Learn more about controlled and uncontrolled components in the <a href="https://react.dev/learn/sharing-state-between-components#controlled-and-uncontrolled-components">React documentation</a>.</Typography>
</div>
...
<Typography className="text-base mb-32" component="div">If you control the <code>{`value`}</code>, make sure it&#39;s referentially stable between renders.
...
<Typography className="text-base mb-32" component="div">In the first example, <code>{`allValues.filter`}</code> is called and returns <strong>a new array</strong> every render.
The fix includes memoizing the value, so it changes only when needed.
:::</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Free solo</Typography>
<Typography className="text-base mb-32" component="div">Set <code>{`freeSolo`}</code> to true so the textbox can contain any arbitrary value.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Search input</Typography>
<Typography className="text-base mb-32" component="div">The prop is designed to cover the primary use case of a <strong>search input</strong> with suggestions, for example Google search or react-autowhatever.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="FreeSolo.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">The value created by typing into the textbox is always a string, regardless of the type of the options.
:::</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Creatable</Typography>
<Typography className="text-base mb-32" component="div">If you intend to use this mode for a <a href="#combo-box">combo box</a> like experience (an enhanced version of a select element) we recommend setting:</Typography>
<ul className="space-y-16">
...
<Typography className="text-base mb-32" component="div">You can group the options with the <code>{`groupBy`}</code> prop.
...
<Typography className="text-base mb-32" component="div">The following demo shows how to use this prop to define custom markup and override the styles of the default groups:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="RenderGroup.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">For advanced customization use cases, a headless <code>{`useAutocomplete()`}</code> hook is exposed.
...
<Typography className="text-base mb-32" component="div">The <code>{`useAutocomplete`}</code> hook is also reexported from @mui/material for convenience and backward compatibility.</Typography>
...
<ul className="space-y-16">
<li>📦 <a href="https://bundlephobia.com/package/@mui/material">4.6 kB gzipped</a>.</li>
</ul>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Asynchronous requests</Typography>
<Typography className="text-base mb-32" component="div">The component supports two different asynchronous use-cases:</Typography>
<ul className="space-y-16">
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Load on open</Typography>
<Typography className="text-base mb-32" component="div">It displays a progress state as long as the network request is pending.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">If your logic is fetching new options on each keystroke and using the current value of the textbox
to filter on the server, you may want to consider throttling requests.</Typography>
<Typography className="text-base mb-32" component="div">Additionally, you will need to disable the built-in filtering of the <code>{`Autocomplete`}</code> component by
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Google Maps place</Typography>
<Typography className="text-base mb-32" component="div">A customized UI for Google Maps Places Autocomplete.
...
<Typography className="text-base mb-32" component="div">The following demo relies on <a href="https://github.com/moroshko/autosuggest-highlight">autosuggest-highlight</a>, a small (1 kB) utility for highlighting text in autosuggest and autocomplete components.</Typography>
</div>
...
:::</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Multiple values</Typography>
<Typography className="text-base mb-32" component="div">Also known as tags, the user is allowed to enter more than one value.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="Tags.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">In the event that you need to lock certain tags so that they can&#39;t be removed, you can set the chips disabled.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="FixedTags.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">You can use the <code>{`limitTags`}</code> prop to limit the number of displayed options when not focused.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="LimitTags.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">Fancy smaller inputs? Use the <code>{`size`}</code> prop.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="Sizes.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Custom input</Typography>
<Typography className="text-base mb-32" component="div">The <code>{`renderInput`}</code> prop allows you to customize the rendered input.
...
<Typography className="text-base mb-32" component="div">To globally customize the Autocomplete options for all components in your app,
...
<Typography className="text-base mb-32" component="div">This demo reproduces GitHub&#39;s label picker:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="GitHubLabel.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Hint</Typography>
<Typography className="text-base mb-32" component="div">The following demo shows how to add a hint feature to the Autocomplete:</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
...
<Typography className="text-base mb-32" component="div">The component exposes a factory to create a filter method that can be provided to the <code>{`filterOptions`}</code> prop.
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3"><code>{`createFilterOptions(config) => filterOptions`}</code></Typography>
<Typography className="text-base mt-12 mb-10" component="h4">Arguments</Typography>
<ol>
...
<Typography className="text-base mt-12 mb-10" component="h4">Returns</Typography>
<Typography className="text-base mb-32" component="div"><code>{`filterOptions`}</code>: the returned filter method can be provided directly to the <code>{`filterOptions`}</code> prop of the <code>{`Autocomplete`}</code> component, or the parameter of the same name for the hook.</Typography>
<Typography className="text-base mb-32" component="div">In the following demo, the options need to start with the query prefix:</Typography>
...
<Typography className="text-base mb-32" component="div">For richer filtering mechanisms, like fuzzy matching, it&#39;s recommended to look at <a href="https://github.com/kentcdodds/match-sorter">match-sorter</a>. For instance:</Typography>
...
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Virtualization</Typography>
<Typography className="text-base mb-32" component="div">Search within 10,000 randomly generated options. The list is virtualized thanks to <a href="https://github.com/bvaughn/react-window">react-window</a>.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="Virtualize.js"
                    className="my-16"
                    iframe={false}
...
<Typography className="text-base mb-32" component="div">If you would like to prevent the default key handler behavior, you can set the event&#39;s <code>{`defaultMuiPrevented`}</code> property to <code>{`true`}</code>:</Typography>
...
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">autocomplete/autofill</Typography>
...
<ul className="space-y-16">
<li><Typography className="text-base mb-32" component="div">Name the input without leaking any information the browser can use. For example <code>{`id="field1"`}</code> instead of <code>{`id="country"`}</code>. If you leave the id empty, the component uses a random id.</Typography>
</li>
<li><Typography className="text-base mb-32" component="div">Set <code>{`autoComplete="new-password"`}</code> (some browsers will suggest a strong password for inputs with this attribute setting):</Typography>
...
<Typography className="text-base mb-32" component="div">Read <a href="https://developer.mozilla.org/en-US/docs/Web/Security/Practical_implementation_guides/Turning_off_form_autocompletion">the guide on MDN</a> for more details.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">iOS VoiceOver</Typography>
<Typography className="text-base mb-32" component="div">VoiceOver on iOS Safari doesn&#39;t support the <code>{`aria-owns`}</code> attribute very well.
You can work around the issue with the <code>{`disablePortal`}</code> prop.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">ListboxComponent</Typography>
<Typography className="text-base mb-32" component="div">If you provide a custom <code>{`ListboxComponent`}</code> prop, you need to make sure that the intended scroll container has the <code>{`role`}</code> attribute set to <code>{`listbox`}</code>. This ensures the correct behavior of the scroll, for example when using the keyboard to navigate.</Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Accessibility</Typography>
<Typography className="text-base mb-32" component="div">(WAI-ARIA: <a href="https://www.w3.org/WAI/ARIA/apg/patterns/combobox/">https://www.w3.org/WAI/ARIA/apg/patterns/combobox/</a>)</Typography>
<Typography className="text-base mb-32" component="div">We encourage the usage of a label for the textbox.
