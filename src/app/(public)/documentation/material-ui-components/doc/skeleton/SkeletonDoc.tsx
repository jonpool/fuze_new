...
function SkeletonDoc(props) {
	return (
		<>
			...
			<Typography className="text-5xl my-16 font-700" component="h1">Skeleton</Typography>
...
<Typography className="text-base mb-32" component="div">The component supports 4 shape variants:</Typography>
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    raw={VariantsRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Animations</Typography>
<Typography className="text-base mb-32" component="div">By default, the skeleton pulsates, but you can change the animation to a wave or disable it entirely.</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="Animations.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={AnimationsRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Pulsate example</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="YouTube.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={YouTubeRaw}
                    /></Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Wave example</Typography>
<Typography className="text-base mb-32" component="div"><FuseExample
                    name="Facebook.js"
                    className="my-16"
                    iframe={false}
                    ...
                    raw={FacebookRaw}
                    /></Typography>
<Typography className="text-3xl mt-24 mb-10 font-700" component="h2">Inferring dimensions</Typography>
<Typography className="text-base mb-32" component="div">In addition to accepting <code>{`width`}</code> and <code>{`height`}</code> props, the component can also infer the dimensions.</Typography>
<Typography className="text-base mb-32" component="div">It works well when it comes to typography as its height is set using <code>{`em`}</code> units.</Typography>
...
<Typography className="text-base mb-32" component="div"><FuseExample
                    ...
                    /></Typography>
<Typography className="text-base mb-32" component="div">But when it comes to other components, you may not want to repeat the width and
...
<Typography className="text-base mb-32" component="div">The color of the component can be customized by changing its <code>{`background-color`}</code> CSS property.
...
<Typography className="text-base mb-32" component="div">Skeleton screens provide an alternative to the traditional spinner method.
...
<Typography className="text-base mb-32" component="div">The background color of the skeleton uses the least amount of luminance to be visible in good conditions (good ambient light, good screen, no visual impairments).</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">ARIA</Typography>
<Typography className="text-base mb-32" component="div">None.</Typography>
<Typography className="text-15 mt-20 mb-10 font-700" component="h3">Keyboard</Typography>
<Typography className="text-base mb-32" component="div">The skeleton is not focusable.</Typography>
