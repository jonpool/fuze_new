...
import AdminRoleExampleConfigRaw from 'src/app/(control-panel)/auth/admin-role-example/page.tsx?raw';
		...
		<>
			...
			<Paper className="max-w-md my-16">
				<Table>
					<TableHead>
						<TableRow>
							<TableCell className="font-semibold text-base">Prop Name</TableCell>
							<TableCell className="font-semibold text-base">Type</TableCell>
							<TableCell className="font-semibold text-base">Description</TableCell>
						</TableRow>
					</TableHead>
					<TableBody>
						<TableRow>
			...
			<Typography
				...
				component="code"
			>
				src/app/(control-panel)/auth/admin-role-example/AdminRoleExampleConfig.tsx
			</Typography>
       ...
       `}
			...
			<Paper className="max-w-md my-16">
				<Table>
					<TableHead>
						<TableRow>
							<TableCell className="font-semibold text-base">User Role options</TableCell>
							<TableCell />
						</TableRow>
					</TableHead>
					<TableBody>
