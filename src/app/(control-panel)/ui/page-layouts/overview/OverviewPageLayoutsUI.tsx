				...
				<div className="flex-auto p-24 sm:p-40">
					<div className="prose prose-sm dark:prose-invert">
						...
						<Typography>
							...
							modified from the component you create.
						</Typography>
						...
						<Typography component="ul">
							...
							<li>
								...
								In the future, if you decide to change the design of your pages, add elements or modify
								the existing ones, it can be done very easily since all your pages will be sharing same
							...
							<li>
								...
								learn for your users. They won't be looking for a save button or a search field over and
								over again, trying to find and memorize their locations for each page since all pages
								will be sharing a similar structure.
							</li>
						</Typography>
					</div>
				</div>
