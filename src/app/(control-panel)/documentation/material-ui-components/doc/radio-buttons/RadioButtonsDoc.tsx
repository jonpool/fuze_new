	...
	return (
		<>
			...
			>
				...
				collapsed, consider using a <a href="/material-ui/react-select/">Select component</a> because it uses
				less space.
			</Typography>
			<Typography
				className="text-base mb-32"
...
`}
			...
			<ul className="space-y-16">
				...
				<li>
					<code>value.onChange</code> (<em>func</em> [optional]): Callback fired when a radio button is
					selected.
				</li>
				<li>
			...
			<ul className="space-y-16">
				<li>
					...
					>
						...
						In most cases, this is done by using the <code>{`<label>`}</code> element (
				...
				<li>
					...
					>
						...
						component. In this case, you can apply the additional attribute (for example{' '}
