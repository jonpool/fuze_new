...
`}
			...
			<Typography
				...
				component="div"
			>
				As a CSS utility component, the Typography component supports all{' '}
				<a href="/system/properties/">
					<code>system</code>
				</a>{' '}
				properties. You can use them as prop directly on the component. For example, here&#39;s how you&#39;d
				add a margin-top:
			</Typography>
